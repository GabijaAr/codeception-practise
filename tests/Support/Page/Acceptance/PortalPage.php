...
class PortalPage
{
    ...
    public const NAV_ITEM__LOGOUT = ['xpath' => '//prt-app//prt-header/fds-header/fds-header-navbar//fds-header-nav/fds-header-nav-item/fds-header-user//fds-header-user-nav/fds-header-user-nav-item[14]'];    
